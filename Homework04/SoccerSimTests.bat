...
echo ======================================  >> testresults.txt
echo [[commented out due to infinte loop condition]] >> testresults.txt
...
echo ======================================  >> testresults.txt
echo [[commented out due to infinte loop condition]] >> testresults.txt
REM @java SoccerSim 200 200 10 10 100 100 -100 -100 150 150 200 200 175 175 -110 -110 20 20 1 1 1.234  >> testresults.txt
